		...
		<article itemscope itemtype="http://schema.org/BlogPosting" class="post leftaside">
			...
			<div id='content-main' class='row'>
				...
				<div class='post-info'>
					...
					<?php if(vicarious_tweet_post_button()) : ?>
					<a id="post-tweet" class="button alt small" href="https://twitter.com/share?text=<?php echo rawurlencode(strip_tags(get_the_title())); ?><?php if(vicarious_tweet_post_attribution()) : ?>&amp;via=<?php echo vicarious_tweet_post_attribution(); ?>&amp;related=<?php echo vicarious_tweet_post_attribution(); ?><?php endif; ?>&amp;url=<?php the_permalink(); ?>&amp;counturl=<?php the_permalink(); ?>" target="_blank">
					<?php _e('Tweet this Post', 'vicarious_theme'); ?>
					</a>
					<?php endif; ?>
