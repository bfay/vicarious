<?php if ( get_option('comment_registration') && !$user_ID ) : ?>
		...
		$comment_field = '<div id="comment-form-content"><label for="comment">' . _x( 'Comment', 'noun', 'vicarious_theme'  ) . '</label><textarea id="comment-form-textarea" placeholder="Your Comment" name="comment" aria-required="true"></textarea></div>';
