	...
	<div id="content-primary" class='row'>
		...
		<div class='main row'>
			...
			<section id="other_projects" class='row'>
				...
				<li class='three columns design_technology'><div><h3><a href="/work/off-vicariouslin-tumblr-theme/" id="projects_offvicariouslin"><small>Off vicariouslin Tumblr theme</small></a></h3><p>The theme is intended for media, such as videos and images, yet still flexible to handle all other content.</p></div></li>
